...
--
-- Client: supabase.rpc('insert_report', { p: payload }) → uuid
-- SECURITY DEFINER so RLS/column-privilege WITH CHECK on contact_* cannot
-- fail the insert. Still forces status, severity, and user_id from auth.
